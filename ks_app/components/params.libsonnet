{
  ...
  components: {
    ...
    "cert-manager": {
      acmeEmail: 'datasciencedude@gmail.com',
    ...
    pipeline: {
      minioPd: 'kubeflowappdir-storage-artifact-store',
      mysqlPd: 'kubeflowappdir-storage-metadata-store',
      name: 'pipeline',
    },
    "pytorch-operator": {
      cloud: 'null',
